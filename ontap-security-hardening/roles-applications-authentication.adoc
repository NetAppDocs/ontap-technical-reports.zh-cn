...
有关 ONTAP System Manager、Active IQ Unified Manager 和 SSH 的多因素身份验证 (MFA) 的详细信息，请参见 link:https://www.netapp.com/pdf.html?item=/media/17055-tr4647.pdf["TR-4647：《ONTAP 9中的多因素身份验证》"^]。
