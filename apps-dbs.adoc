...
link:https://docs.netapp.com/us-en/ontap-apps-dbs/mssql/overview.html["采用ONTAP的Microsoft SQL Server最佳实践"]
...
link:https://docs.netapp.com/us-en/ontap-apps-dbs/mysql/overview.html["基于NetApp ONTAP的MySQL数据库最佳实践"]
...
link:https://docs.netapp.com/us-en/ontap-apps-dbs/oracle/overview.html["基于ONTAP的Oracle数据库"]
了解可帮助存储管理员和数据库管理员在ONTAP存储上成功部署Oracle的建议做法。

link:https://docs.netapp.com/us-en/ontap-apps-dbs/oracle/dp/oracle-data-protection-introduction.html["借助ONTAP实现Oracle数据保护"]
了解可帮助存储管理员和数据库管理员成功备份、恢复、复制基于ONTAP存储的Oracle并提供灾难恢复的建议做法。

link:https://docs.netapp.com/us-en/ontap-apps-dbs/oracle/dr/oracle-dr-overview.html["借助ONTAP实现Oracle灾难恢复"]
了解在MetroCluster和SnapMirror业务连续性上运行Oracle数据库的建议实践、测试过程以及其他注意事项。

link:https://docs.netapp.com/us-en/ontap-apps-dbs/oracle/migration/oracle-migration-overview.html["将Oracle数据库迁移到ONTAP存储系统"]
...
link:https://docs.netapp.com/us-en/ontap-apps-dbs/postgres/overview.html["基于ONTAP最佳实践的PostgreSQL数据库"]
